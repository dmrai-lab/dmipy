<!-- generated by tools/gen_replay_guide.py from dmrai-lab/dmipy-sim@e9d480836ebb docs/replay-guide; edit it there -->
# The replay guide
...
(`tests/test_replay_guide.py` in dmipy-sim, and `tools/run_snippets.py` on this site), so a block that no longer runs is a page that fails.
