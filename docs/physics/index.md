...
| **[Susceptibility](susceptibility.md)** | ✅ Operational (sim) | off-resonance field on the walk — iron spheres / myelin hollow-cylinder / voxel grid | $R_2'$ transverse term |
...
!!! note "Released vs planned"
    ...
    (analytics ↔ Monte Carlo). ✅ **Operational (sim)** means the forward simulator carries the
    effect and is validated against analytics + the literature; the matched analytical inverse
    follows. 🔬 **Planned** effects are part of the physics-complete model and the internal
    roadmap. The boundary is a *release* boundary, not the ceiling.
